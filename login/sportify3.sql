...
INSERT INTO `Equipment` (EquipmentID, EquipmentName, Description,YouTubeURL)
VALUES
  (1, 'Treadmill', 'Cardio equipment for running or walking','https://youtu.be/8i3Vrd95o2k?si=U7uHytbuhsrV7Ei9'),
  (2, 'Dumbbells', 'Weight training equipment for strength exercises','https://youtu.be/8i3Vrd95o2k?si=U7uHytbuhsrV7Ei9'),
  (3, 'Yoga Mat', 'Mat for yoga and stretching exercises','https://youtu.be/8i3Vrd95o2k?si=U7uHytbuhsrV7Ei9');
...
-- Repeat the above UPDATE statement for other equipment entries
